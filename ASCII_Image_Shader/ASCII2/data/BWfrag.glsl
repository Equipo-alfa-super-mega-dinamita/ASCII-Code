...
{
	//Escalado de p para coincidir con la altura y anchura. Inversión de p.y por la manera en que se codifican los caracteres
...
void main() {
	...
	//División del área en secciones de 8 x 8 px y normalización de los valores de -1 a 1
